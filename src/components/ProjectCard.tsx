...
export function ProjectCard({
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col overflow-visible rounded-xl border border-line bg-bg-card p-6 transition-all duration-300 hover:z-10 hover:-translate-y-0.5 hover:border-accent/40 hover:shadow-glow"
    >
      {/* Constelação das stacks — salta do centro do card no hover (decorativa) */}
      <ProjectStack technologies={project.technologies} />

      <div className="tech-burst-body flex flex-1 flex-col">
        {/* número + status */}
